...
//        super.doFilterInternal(request, response, chain);
        ...
        // 서명이 정상적으로 됨
        // SecurityConfig로 가서 JwtAuthorizationFilter에 userRepository를 넘겨줌
        if(username!=null){
            ...
            Authentication authentication = new UsernamePasswordAuthenticationToken(principalDetails, null,principalDetails.getAuthorities()); // password는 null이어도 됨: 강제로 authentication 객체를 만듦
